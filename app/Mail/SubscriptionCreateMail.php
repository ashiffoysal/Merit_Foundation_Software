...
class SubscriptionCreateMail extends Mailable
{
    ...
    protected function resolveDisplayData(): void
    {
        ...
        // Ask Stripe for the human-readable plan/product name and billing
        // interval tied to this subscription's price. Wrapped in a
        // try/catch so a Stripe API hiccup never blocks the confirmation
        // email from sending.
