...
<body>
    ...
    <div id="modal-view-message" class="modal-backdrop" style="display:none"
        onclick="closeModalOutside(event,'modal-view-message')">
        <div class="modal-box" style="max-width:560px">
            <div class="modal-header-custom">
                <div class="card-title"><i class="fas fa-envelope-open-text"></i> Message Detail</div>
                <button class="modal-close-btn" onclick="closeModal('modal-view-message')"><i
                        class="fas fa-times"></i></button>
            </div>
            <div class="modal-body-custom" id="messageDetailBody">
                <div class="msg-detail-row"><span class="msg-label">Name</span><span id="md-name"
                        class="msg-val"></span></div>
                <div class="msg-detail-row"><span class="msg-label">Email</span><span id="md-email"
                        class="msg-val"></span></div>
                <div class="msg-detail-row"><span class="msg-label">Phone</span><span id="md-phone"
                        class="msg-val"></span></div>
                <div class="msg-detail-row"><span class="msg-label">Subject</span><span id="md-subject"
                        class="msg-val"></span></div>
                <div class="msg-detail-row"><span class="msg-label">Status</span><span id="md-status"
                        class="msg-val"></span></div>
                <div class="msg-detail-row"><span class="msg-label">Date</span><span id="md-date"
                        class="msg-val"></span></div>
                <div class="msg-detail-row msg-detail-msg"><span class="msg-label">Message</span>
                    <div id="md-message" class="msg-val msg-body-text"></div>
                </div>
            </div>
            <div class="modal-footer-custom d-flex justify-content-between align-items-center">
                <div class="d-flex gap-2">
                    <button class="btn-prim btn-sm" id="md-mark-read" onclick="markStatus(currentMsgId,'read')"><i
                            class="fas fa-check"></i> Mark Read</button>
                    <button class="btn-outline-sm btn-sm" id="md-mark-pending"
                        onclick="markStatus(currentMsgId,'pending')"><i class="fas fa-clock"></i> Pending</button>
                </div>
                <button class="btn-danger-sm btn-sm" onclick="deleteMessage(currentMsgId)"><i class="fas fa-trash"></i>
                    Delete</button>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        window.addEventListener('load', () => setTimeout(() => {
            document.getElementById('pg-loader').classList.add('done')
        }, 1200));
      ...
      <td><div class="d-flex gap-1"><button class="btn-outline-sm" style="padding:4px 10px;font-size:.68rem" onclick="openModal('student')"><i class="fas fa-eye"></i></button><button class="btn-outline-sm" style="padding:4px 10px;font-size:.68rem"><i class="fas fa-edit"></i></button><button class="btn-danger-sm" style="padding:4px 10px;font-size:.68rem"><i class="fas fa-trash"></i></button></div></td>
        ...
        const modalContent = {
            'student': {
                ...
                sub: 'View and manage student details',
                body: `
    <div class="row g-3">
      ...
      <div class="col-12"><button class="btn-gold-sm" style="width:100%;justify-content:center"><i class="fas fa-save"></i>Save Changes</button></div>
            ...
            'add-student': {
                ...
                sub: 'Register a student on the system',
                body: `
    <div class="row g-3">
      ...
      <div class="col-12"><button class="btn-gold-sm" style="width:100%;justify-content:center"><i class="fas fa-plus"></i>Add Student</button></div>
            ...
            'add-lesson': {
                ...
                sub: 'Book a new one-to-one session',
                body: `
    <div class="row g-3">
      ...
      <div class="col-12"><button class="btn-gold-sm" style="width:100%;justify-content:center"><i class="fas fa-calendar-check"></i>Schedule Lesson</button></div>
            ...
            'add-donation': {
                ...
                sub: 'Add a manually recorded donation',
                body: `
    <div class="row g-3">
      ...
      <div class="col-12"><button class="btn-gold-sm" style="width:100%;justify-content:center"><i class="fas fa-heart"></i>Record Donation</button></div>
            ...
            'add-article': {
                title: 'New Article',
                sub: 'Publish content to the website',
                body: `
    <div class="row g-3">
      ...
      <div class="col-12"><button class="btn-gold-sm" style="width:100%;justify-content:center"><i class="fas fa-pen"></i>Create Article</button></div>
            ...
            'add-tutor': {
                title: 'Add Tutor',
                sub: 'Register a new tutor on the system',
                body: `
    <div class="row g-3">
