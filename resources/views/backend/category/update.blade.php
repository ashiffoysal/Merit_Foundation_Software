...
<div class="container">
    <div class="page-header d-flex align-items-center justify-content-between">
        <div>
            <h1>Edit Category</h1>
            <p>Update blog category details</p>
        </div>
        <a href="{{ route('admin.category.index') }}" class="btn-outline-sm">
            ...
            <div class="card mb-4">
                <div class="card-header-custom">
                    <div class="card-title">
                        <i class="fas fa-folder-open"></i> Edit Category — <span class="text-muted fw-normal">{{ $category->category_name }}</span>
                    </div>
                </div>
