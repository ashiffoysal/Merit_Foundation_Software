...
<div class="container py-4" style="max-width: 1200px; margin-top: 100px;">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
        <div>
            <h3 class="fw-semibold mb-1">Trial Details</h3>
            <p class="text-muted mb-0">Full enquiry information for {{ $lead->parent_name }}.</p>
        </div>
        <a href="{{ url('admin/free-trial') }}" class="btn btn-outline-secondary rounded-3">
            ...
            <div class="card card-soft h-100">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="info-value">{{ $lead->child_name }} </div>
                    </div>

                    <div class="mb-3">
                        <div class="info-label">Age</div>
                        <div class="info-value">{{ $lead->child_age ?? '-' }}</div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="info-value">
                            @if($lead->preferred_tutor == 'Male')
                                <span class="badge bg-primary rounded-pill">Male Tutor</span>
                            @elseif($lead->preferred_tutor == 'Female')
                    ...
                    <div class="mb-0">
                        ...
                        <div class="info-value">{{ $lead->time ?? '-' }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card card-soft h-100">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="info-value">{{ $lead->whatsapp }}</div>
                    </div>
                    <div class="mb-3">
