...
.page-hero::before{
  ...
  background:
    radial-gradient(ellipse 70% 80% at 40% 50%, rgb(26 122 79 / 85%), transparent 60%);
}
.page-hero::after{
  content:'';position:absolute;inset:0;
  background-image:
...
<div id="" class="">
              ...
              <div class="ls-body">
                ...
                <div style="background:var(--white);border:1px solid var(--border);border-radius:14px;padding:24px 22px;margin-top:16px">
                  <div class="row g-3">
                    ...
                    <div class="col-md-6"><div style="display:flex;gap:12px;align-items:flex-start"><div style="width:36px;height:36px;border-radius:9px;background:rgba(201,168,76,.1);display:flex;align-items:center;justify-content:center;flex-shrink:0"><i class="fas fa-envelope" style="color:var(--gold);font-size:.8rem"></i></div><div><div style="font-size:.72px;color:var(--muted);letter-spacing:1px;margin-bottom:3px;font-size:.72rem">Email</div><div style="font-size:.85rem;font-weight:600;color:var(--navy)">{{ $companyInfo ? $companyInfo->primary_email : '' }}</div></div></div></div>
                    <div class="col-md-6"><div style="display:flex;gap:12px;align-items:flex-start"><div style="width:36px;height:36px;border-radius:9px;background:rgba(201,168,76,.1);display:flex;align-items:center;justify-content:center;flex-shrink:0"><i class="fas fa-phone" style="color:var(--gold);font-size:.8rem"></i></div><div><div style="font-size:.72rem;color:var(--muted);letter-spacing:1px;margin-bottom:3px">Phone</div><div style="font-size:.85rem;font-weight:600;color:var(--navy)">{{ $companyInfo ? $companyInfo->phone : '' }}</div></div></div></div>
                    <div class="col-md-6"><div style="display:flex;gap:12px;align-items:flex-start"><div style="width:36px;height:36px;border-radius:9px;background:rgba(201,168,76,.1);display:flex;align-items:center;justify-content:center;flex-shrink:0"><i class="fas fa-map-marker-alt" style="color:var(--gold);font-size:.8rem"></i></div><div><div style="font-size:.72rem;color:var(--muted);letter-spacing:1px;margin-bottom:3px">Address</div><div style="font-size:.85rem;font-weight:600;color:var(--navy)">{{ $companyInfo ? $companyInfo->address : '' }}</div></div></div></div>
                  </div>
                </div>
              </div>
            </div>
  ...
  <div class="cta-strip"><div class="container"><div class="inner"><div class="row align-items-center g-4">
    ...
    <div class="col-lg-5 d-flex flex-wrap gap-3 justify-content-lg-end">
      <a href="{{ url('/contact') }}" class="btn-gold-nav" style="background:var(--navy);color:#fff"><i class="fas fa-envelope"></i>Contact Us</a>
      <a href="{{ url('/book-lesson') }}" class="btn-ghost-nav" style="border-color:rgba(15,31,92,.3);color:var(--navy)">Book a Lesson</a>
    </div>
  </div></div></div></div>
