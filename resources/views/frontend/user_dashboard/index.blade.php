 ...
 --}}
      ...
      <div id="dash-profile" class="dash-panel">
        ...
        <div class="profile-section">
          ...
          <div class="row g-3">
            <div class="col-md-6"><div class="field-group"><label class="field-label">First Name *</label><input type="text" class="field-input" value="Ayesha" id="prof-fname"><p class="field-hint">Your legal first name as on official documents</p></div></div>
            <div class="col-md-6"><div class="field-group"><label class="field-label">Last Name *</label><input type="text" class="field-input" value="Malik" id="prof-lname"></div></div>
            <div class="col-md-6"><div class="field-group"><label class="field-label">Email Address *</label><input type="email" class="field-input" value="ayesha.malik@email.com" id="prof-email"><p class="field-hint">Used for login and lesson notifications</p></div></div>
            <div class="col-md-6"><div class="field-group"><label class="field-label">Phone Number</label><input type="tel" class="field-input" value="+44 7000 000000" id="prof-phone"></div></div>
            <div class="col-md-6"><div class="field-group"><label class="field-label">Date of Birth</label><input type="date" class="field-input" value="1985-06-15"></div></div>
            <div class="col-md-6"><div class="field-group"><label class="field-label">Gender</label><select class="field-select"><option selected>Female</option><option>Male</option><option>Prefer not to say</option></select></div></div>
          </div>
        </div>
        ...
        <div class="profile-section">
          ...
          <div class="row g-3">
            <div class="col-12"><div class="field-group"><label class="field-label">Address Line 1</label><input type="text" class="field-input" value="14 Maple Street"></div></div>
            <div class="col-12"><div class="field-group"><label class="field-label">Address Line 2</label><input type="text" class="field-input" value="Flat 2"></div></div>
            <div class="col-md-6"><div class="field-group"><label class="field-label">City</label><input type="text" class="field-input" value="London"></div></div>
            <div class="col-md-3"><div class="field-group"><label class="field-label">Postcode</label><input type="text" class="field-input" value="E1 6RF"></div></div>
            <div class="col-md-3"><div class="field-group"><label class="field-label">Country</label><select class="field-select"><option selected>United Kingdom</option><option>Bangladesh</option><option>Other</option></select></div></div>
          </div>
        </div>
        ...
        <div class="profile-section">
          ...
          <div class="row g-3">
            <div class="col-md-6"><div class="field-group"><label class="field-label">Student Name</label><input type="text" class="field-input" value="Ibrahim Malik"></div></div>
            <div class="col-md-3"><div class="field-group"><label class="field-label">Age</label><input type="number" class="field-input" value="9"></div></div>
            <div class="col-md-3"><div class="field-group"><label class="field-label">Current Level</label><select class="field-select"><option>Beginner</option><option selected>Qaida</option><option>Reading Quran</option><option>Tajweed</option></select></div></div>
            <div class="col-12"><div class="field-group"><label class="field-label">Learning Goals / Notes</label><textarea class="field-textarea" rows="3">Ibrahim is working towards completing Qaida and moving to full Quran reading. He practices 15 minutes daily at home.</textarea></div></div>
          </div>
        </div>
        ...
        <!-- Gift Aid -->
        <div class="profile-section">
          <div class="profile-section-title"><i class="fas fa-gift"></i>Gift Aid Declaration</div>
          <p style="font-size:.83rem;color:var(--muted);margin-bottom:16px;line-height:1.7">If you are a UK taxpayer, declaring Gift Aid allows us to claim an additional 25p for every £1 you donate at no extra cost to you. Please confirm your status below.</p>
          <div class="toggle-row">
            <div class="toggle-info"><h6>I am a UK taxpayer</h6><p>I pay enough UK income tax to cover Gift Aid on my donations</p></div>
            <label class="toggle-switch"><input type="checkbox" checked><span class="toggle-slider"></span></label>
          </div>
          <p style="font-size:.75rem;color:var(--muted);margin-top:12px;font-style:italic">You must notify us if your circumstances change and you no longer pay sufficient UK tax.</p>
        </div>
