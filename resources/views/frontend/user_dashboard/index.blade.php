...
@section('title', 'Dashboard - Merit Education Foundation')
@section('content')
    ...
    <style>
      ...
      ════════════════════════════════════════════════ */
        ...
        @media (max-width: 575px) {
            ...
            #dash-profile>.d-flex.gap-3.mt-2 {
                flex-direction: column;
            }
    ...
    --}}
                ...
                <div class="dash-sidebar-inner">
                    <div class="dash-user-block">
                        <div class="dash-av-wrap">
                            ...
                            <div class="dash-av-edit" onclick="switchDash('profile')"><i class="fas fa-pencil-alt"></i>
                            </div>
                        </div>
                    ...
                    <div class="dash-nav-item active" onclick="switchDash('overview')"><i
                    ...
                    <div class="dash-nav-item" onclick="switchDash('documents')"><i class="fas fa-file-alt"></i>My Plans
                    </div>

                    <div class="dash-nav-item" onclick="switchDash('settings')"><i class="fas fa-cog"></i>Invoice</div>
                    <div class="dash-logout">
                        <a class="dash-logout-btn" href="{{ url('userlogout') }}"><i class="fas fa-sign-out-alt"></i>Sign
                            Out</a>
                    </div>
                </div>
            </aside>
            ...
            <main class="dash-main">
                <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:28px">
                    <div>
                        <div class="dash-breadcrumb"><span>Merit</span><i class="fas fa-chevron-right"></i><span
                                id="breadcrumb-txt">Dashboard</span></div>
                        <h1 class="dash-h1" id="dash-main-title">@php echo date('g:i A'); @endphp, <em
                                style="font-style:italic;color:var(--gold)">{{ Auth::user()->name }}</em> 👋</h1>
                        <p class="dash-sub">Here's an overview of your account and recent activity.</p>
                    </div>
                    <div class="d-flex gap-2">
                        <a class="btn-outline-navy btn-sm" href="{{ url('/book-lesson') }}"><i class="fas fa-plus"></i>Book
                            Lesson</a>
                ...
                <div id="dash-overview" class="dash-panel active">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-6 col-xl-3">
                            <div class="ds-stat">
                                <div class="ds-stat-icon" style="background:rgba(201,168,76,.1)"><i
                                        class="fas fa-graduation-cap" style="color:var(--gold)"></i></div>
                                <div class="ds-stat-val"></div>
                                <div class="ds-stat-lbl">Total Lessons</div>
                                <div class="ds-stat-change change-up"><i class="fas fa-arrow-up"></i></div>
                            </div>
                        </div>
                        <div class="col-6 col-xl-3">
                            <div class="ds-stat">
                                <div class="ds-stat-icon" style="background:rgba(13,107,99,.1)"><i class="fas fa-heart"
                                        style="color:var(--teal)"></i></div>
                                <div class="ds-stat-val"></div>
                                <div class="ds-stat-lbl">Total Donated</div>
                                <div class="ds-stat-change change-up"><i class="fas fa-arrow-up"></i></div>
                            </div>
                        </div>
                        <div class="col-6 col-xl-3">
                            <div class="ds-stat">
                                <div class="ds-stat-icon" style="background:rgba(15,31,92,.07)"><i class="fas fa-child"
                                        style="color:var(--navy)"></i></div>
                                <div class="ds-stat-val"></div>
                                <div class="ds-stat-lbl">Child Sponsored</div>
                                <div class="ds-stat-change change-neu"><i class="fas fa-minus"></i></div>
                            </div>
                        </div>
                        <div class="col-6 col-xl-3">
                            <div class="ds-stat">
                                <div class="ds-stat-icon" style="background:rgba(201,168,76,.1)"><i class="fas fa-star"
                                        style="color:var(--gold)"></i></div>
                                <div class="ds-stat-val"></div>
                                <div class="ds-stat-lbl">Quran Progress</div>
                                <div class="ds-stat-change change-up"><i class="fas fa-arrow-up"></i></div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="profile-section">
                                ...
                                <div style="margin-bottom:16px">
                                    <div style="display:flex;justify-content:space-between;margin-bottom:6px"><span
                                            style="font-size:.8rem;font-weight:600;color:var(--navy)">Quran
                                            Recitation</span><span
                                            style="font-size:.8rem;color:var(--gold);font-weight:700">68%</span></div>
                                    <div class="prog-bar-wrap">
                                        <div class="prog-bar" style="width:68%"></div>
                                    </div>
                                </div>
                                <div style="margin-bottom:16px">
                                    <div style="display:flex;justify-content:space-between;margin-bottom:6px"><span
                                            style="font-size:.8rem;font-weight:600;color:var(--navy)">Tajweed
                                            Rules</span><span
                                            style="font-size:.8rem;color:var(--gold);font-weight:700">42%</span></div>
                                    <div class="prog-bar-wrap">
                                        <div class="prog-bar" style="width:42%"></div>
                                    </div>
                                </div>
                                <div>
                                    <div style="display:flex;justify-content:space-between;margin-bottom:6px"><span
                                            style="font-size:.8rem;font-weight:600;color:var(--navy)">Memorisation
                                            (Hifz)</span><span
                                            style="font-size:.8rem;color:var(--gold);font-weight:700">25%</span></div>
                                    <div class="prog-bar-wrap">
                                        <div class="prog-bar" style="width:25%"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <div class="field-group">
                                    ...
                                    <input type="text" class="field-input" id="prof-fname"
                                        value="{{ $user->name }}">
                            ...
                            <div class="col-md-6">
                                <div class="field-group">
                                    ...
                                    <input type="text" class="field-input" id="prof-lname"
                            ...
                            <div class="col-md-6">
                                <div class="field-group">
                                    ...
                                    <input type="email" class="field-input" id="prof-email"
                                        value="{{ $user->email }}">
                            ...
                            <div class="col-md-6">
                                <div class="field-group">
                                    ...
                                    <input type="tel" class="field-input" id="prof-phone"
                                        value="{{ $user->phone }}">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <div class="field-group">
                                    ...
                                    <input type="text" name="address_line_1" class="field-input"
                            ...
                            <div class="col-12">
                                <div class="field-group">
                                    ...
                                    <input type="text" name="address_line_2" class="field-input"
                            ...
                            <div class="col-md-3">
                                <div class="field-group">
                                    ...
                                    <input type="text" name="postcode" class="field-input"
                                        value="{{ $user->postcode }}">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <div class="field-group">
                                    ...
                                    <input type="text" name="student_name" class="field-input"
                            ...
                            <div class="col-md-3">
                                <div class="field-group">
                                    ...
                                    <input type="number" name="age" class="field-input"
                                        value="{{ $user->age }}">
...
════════════════════════════════════════════════ --}}
                ...
                <div id="dash-notifications" class="dash-panel">
                    <div class="profile-section">
                        <div class="profile-section-title"><i class="fas fa-bell"></i>Notifications <span
                                style="background:var(--gold);color:var(--navy);font-size:.65rem;font-weight:800;padding:3px 10px;border-radius:20px;margin-left:8px">5
                                New</span></div>
                        <div class="notification-item">
                            <div class="ni-dot"></div>
                            <div class="ni-ic" style="background:rgba(13,107,99,.1)"><i class="fas fa-check"
                                    style="color:var(--teal)"></i></div>
                            <div style="flex:1">
                                <div class="ni-title">Lesson Completed Successfully</div>
                                <div class="ni-body">Your session with Ustadh Bilal on Surah Yasin was completed. Your
                                    progress report is now available.</div>
                                <div class="ni-time"><i class="fas fa-clock"></i>15 Nov 2025 · 4:50 PM</div>
                            </div>
                        </div>
                        <div class="notification-item">
                            <div class="ni-dot"></div>
                            <div class="ni-ic" style="background:rgba(201,168,76,.1)"><i class="fas fa-heart"
                                    style="color:var(--gold)"></i></div>
                            <div style="flex:1">
                                <div class="ni-title">Monthly Donation Processed</div>
                                <div class="ni-body">Your £20 monthly donation has been processed and Gift Aid applied.
                                    Receipt emailed to you.</div>
                                <div class="ni-time"><i class="fas fa-clock"></i>1 Nov 2025 · 9:00 AM</div>
                            </div>
                        </div>
                        <div class="notification-item">
                            <div class="ni-dot"></div>
                            <div class="ni-ic" style="background:rgba(15,31,92,.07)"><i class="fas fa-calendar"
                                    style="color:var(--navy)"></i></div>
                            <div style="flex:1">
                                <div class="ni-title">Lesson Reminder — Tomorrow</div>
                                <div class="ni-body">You have a Tajweed session with Ustadh Bilal tomorrow at 4:00 PM.
                                    Check your Zoom link below.</div>
                                <div class="ni-time"><i class="fas fa-clock"></i>17 Nov 2025 · 8:00 AM</div>
                            </div>
                        </div>
                        <div class="notification-item">
                            <div class="ni-ic" style="background:rgba(201,168,76,.1)"><i class="fas fa-star"
                                    style="color:var(--gold)"></i></div>
                            <div style="flex:1">
                                <div class="ni-title">October Progress Report Ready</div>
                                <div class="ni-body">Ibrahim's October learning report is available. He has shown excellent
                                    improvement in Tajweed rules.</div>
                                <div class="ni-time"><i class="fas fa-clock"></i>25 Oct 2025 · 11:00 AM</div>
                            </div>
                        </div>
                        <div class="notification-item">
                            <div class="ni-ic" style="background:rgba(13,107,99,.1)"><i class="fas fa-newspaper"
                                    style="color:var(--teal)"></i></div>
                            <div style="flex:1">
                                <div class="ni-title">New Article: 5,000 Students Reached</div>
                                <div class="ni-body">Merit Education Foundation has reached a major milestone. Read the
                                    full story on our News page.</div>
                                <div class="ni-time"><i class="fas fa-clock"></i>15 Nov 2025 · 10:00 AM</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div id="dash-settings" class="dash-panel">
                    <div class="profile-section">
                        <div class="profile-section-title"><i class="fas fa-bell"></i>Invoice</div>
                ...
                <div id="dash-documents" class="dash-panel">
                    <div class="profile-section">
                        ...
                        <div class="row g-3">
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    @forelse ($subscriptions as $subscription)
                                        <tr>
                                            @php
                                                $planName = App\Models\Plan::where(
                                                    'stripe_price_id',
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    <span
                                                        class="badge bg-light text-dark">{{ $subscription->stripe_status }}</span>
                                                @endif
                                            ...
                                            <td>
                                                @if ($subscription->stripe_status === 'paused')
                                                    {{-- RESUME --}}
                                                    <form method="POST"
                                                        action="{{ route('subscriptions.resume', $subscription->id) }}"
                                                        class="d-inline">
                                                        @csrf
                                                ...
                                                @elseif($subscription->active() && !$subscription->onGracePeriod())
                                                    {{-- PAUSE --}}
                                                    <form method="POST"
                                                        action="{{ route('subscriptions.pause', $subscription->id) }}"
                                                        class="d-inline">
                                                        @csrf
                                                    ...
                                                    {{-- CANCEL NOW --}}
                                                    <form method="POST"
                                                        action="{{ route('subscriptions.cancelNow', $subscription->id) }}"
                                                        class="d-inline">
                                                        @csrf
                            ...
                            <div class="col-md-6">
                                <div style="background:var(--cream);border:1px solid var(--border);border-radius:12px;padding:20px;display:flex;align-items:center;gap:14px;transition:.3s;cursor:pointer"
                                    onmouseover="this.style.borderColor='var(--gold)'"
                                    onmouseout="this.style.borderColor='var(--border)'">
                                    <div
                                        style="width:42px;height:42px;background:rgba(201,168,76,.1);border-radius:10px;display:flex;align-items:center;justify-content:center">
                                        <i class="fas fa-file-pdf" style="color:var(--gold)"></i></div>
                                    <div>
                                        <div style="font-size:.85rem;font-weight:600;color:var(--navy)">October Progress
                                            Report</div>
                                        <div style="font-size:.72rem;color:var(--muted)">PDF · 25 Oct 2025</div>
                                    </div><i class="fas fa-download" style="color:var(--muted);margin-left:auto"></i>
                                </div>
                            </div>
    ...
    <script>
        ...
        $('.btn-outline-navy:contains("Update Password")').on('click', function() {
            ...
            let hasError = false;
            if (!current) {
                showPasswordError(0, 'Enter your current password.');
                hasError = true;
            }
            if (!newPass || newPass.length < 8) {
                showPasswordError(1, 'Min 8 characters.');
                hasError = true;
            }
            if (newPass !== confirm) {
                showPasswordError(2, 'Passwords do not match.');
                hasError = true;
            }
            if (hasError) return;
