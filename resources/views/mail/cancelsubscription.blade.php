      ...
      <tr>
        <td align="center" style="padding:24px 12px;">
          ...
          <table role="presentation" class="email-container" width="600" cellpadding="0" cellspacing="0" border="0" style="width:600px; max-width:600px; background-color:#F7F3E9; border-radius:12px; overflow:hidden; box-shadow:0 4px 18px rgba(27,58,47,0.08);">
                ...
                <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                  <tr>
                    <td width="64" height="64" align="center" valign="middle" style="background-color:#F3EBD3; border-radius:50%;">
                      <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                        <tr>
                          <td width="40" height="40" align="center" valign="middle" style="background-color:#1B3A2F; border-radius:50%; font-family:Georgia, serif; font-size:18px; color:#D4AF37;">
                            &#128075;
                          </td>
                        </tr>
                      </table>
            ...
            <tr>
              <td align="center" class="fluid-padding" style="padding:18px 40px 0 40px;">
                <h1 class="headline" style="margin:0; font-family:Georgia, 'Times New Roman', serif; font-size:28px; line-height:34px; color:#1B3A2F; font-weight:bold;">
                  We're Sorry to See You <span style="color:#C9A24B; font-style:italic;">Go</span>
                </h1>
              </td>
            </tr>
            ...
            <!-- =============== INFO CARD: CANCELLATION DETAILS =============== -->
            <tr>
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#FFFFFF; border:1px solid #E5DEC8; border-radius:10px;">
                  ...
                  <tr>
                    <td style="padding:12px 24px 0 24px;">
                      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                        <tr>
                          <td class="detail-label" width="150" valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:13px; color:#8A8D82; font-weight:bold;">Cancellation Date</td>
                          <td class="detail-value" valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#1B3A2F;">{{cancel_date}}</td>
                        </tr>
                      </table>
                    </td>
                  </tr>
            ...
            <tr>
              <td class="fluid-padding" style="padding:14px 40px 8px 40px;">
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                  <tr>
                  ...
                  <tr>
                    <td width="30" valign="top" style="padding-bottom:14px; font-family:Arial, sans-serif; font-size:14px; color:#D4AF37;">&#9679;</td>
                    <td valign="top" style="padding-bottom:14px; font-family:Arial, Helvetica, sans-serif; font-size:14px; line-height:20px; color:#4A4E44;">
                      After that date, your account moves to a free, read-only state — your learning history is kept safe.
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; line-height:20px; color:#4A4E44;">
                      No further payments will be taken from this point onward.
                    </td>
                  </tr>
                </table>
              </td>
